...
@interface FCViewController () <ABPeoplePickerNavigationControllerDelegate>
...
#pragma mark - ABPeoplePickerNavigationontrollerDelegate
#pragma mark -

- (void)peoplePickerNavigationControllerDidCancel:(ABPeoplePickerNavigationController *)peoplePicker
{
    // キャンセルが押されたときは何もせずに、ABPeoplePickerNavigationControllerを閉じる
...
{
    // 選択されたレコード、プロパティを元に、ContactRecordオブジェクトを作成
    ContactRecord *record = [[ContactRecord alloc] initWithPerson:person property:property identifier:identifier];
    
    // 作成されたContactRecordをマネージャに追加し、保存
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSData *imageDate = (__bridge_transfer NSData *)ABPersonCopyImageDataWithFormat(person, kABPersonImageFormatThumbnail);
    ...
    // プロパティIDとmultiValueIdentifierから、プロパティの特定の値を取得し、詳細ラベルに設定
    // （複数ある電話番号またはメールアドレス）から１つを取得
